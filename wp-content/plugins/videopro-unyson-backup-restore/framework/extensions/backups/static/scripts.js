...
jQuery(function($){
	var inst = {
		...
		init: function(){
			...
			// Cactus custom create demo button
			this.$el.on('click', '[data-create-file]', function(){
				var $this = $(this),
					confirm_message = $this.attr('data-confirm');
				...
				$.ajax({
					...
					dataType: 'json',
					data: {
						action: inst.localized.ajax_action_create,
						file: $(this).attr('data-create-file')
					}
				})
				.done(function(r){
					if (r.success) {
			...
			//create remote demo
			// Cactus custom create demo button
			// this.$el.on('click', '[data-create-remote-file]', function(){
			// 	var $this = $(this),
			// 		confirm_message = $this.attr('data-confirm');
			...
			// 		dataType: 'json',
			// 		data: {
			// 			action: inst.localized.ajax_action_creat_remote,
			// 			file: $(this).attr('data-create-remote-file')
			// 		}
			// 	})
			// 	.done(function(r){
			// 		if (r.success) {
			...
			this.$el.on('click', '[data-download-demo-file]', function(e) {
				if (fw_ext_backups_is_busy) {
					e.preventDefault();
					window.scrollTo(0, 0);
					return;
